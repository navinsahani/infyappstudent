        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
              <a class="nav-link" >
                  ...
                  <span>Hello ,{{session('user')}}</span></a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/addstudent">Student Entries</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Update Student Data</h1>
                    
                    <form class="user"  action={{route('todo.update',[$studenttable->id])}} method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <input  class="form-control form-control-user"
                            type="hidden" name="id" value="{{ $studenttable->id }}" >
                        </div>
                        <div class="form-group">
                            <input  class="form-control form-control-user"
                            type="text" name="student_name" placeholder="Enter Student Namee" value="{{ $studenttable->student_name }}" required>
                        </div>
                        <div class="form-group">
                            <input  class="form-control form-control-user"
                            type="text" name="student_standard" placeholder="Enter Which Standard" value="{{ $studenttable->student_standard }}" required>
                        </div>
                        <div class="form-group">
                            <input  class="form-control form-control-user"
                            type="Text" name="student_seatnumber" placeholder="Enter Seat Number" value="{{ $studenttable->student_seatnumber }}" required>
                        </div>
                        <div class="form-group">
                            <input  class="form-control form-control-user"
                            type="Text" name="student_courses" placeholder="Enter Courses Name" value="{{ $studenttable->student_courses }}" required>
                        </div>
                        <div class="form-group">
                            <input  class="form-control form-control-user"
                            type="Text" name="student_phonenumber" placeholder="Enter Phone Number" value="{{ $studenttable->student_phonenumber }}" required>
                        </div>
                        <button type="submit"onclick="myFunction()" class="btn btn-primary btn-icon-split" style="    padding: 10px 20px 10px 20px;
                        " >Submit</button>
                         <script>
                            function myFunction() {
                                alert("Are Sure Update the Data!!");
                                }
                                </script>
                                <button type="reset" class="btn btn-denger btn-icon-split" style="    padding: 10px 20px 10px 20px;
                                ">Cancel</button>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                      <span>Copyright &copy;infyappdevelopment 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
